...
const UserPortrait = ({
  ...
  return (
    <div
      className={cn(
        "relative size-10 rounded-full border border-neutral-200 dark:border-neutral-500",
        className,
      )}>
      <div className="size-full overflow-hidden rounded-full">
        <img
          ...
          alt="프로필 이미지"
          className="size-full min-w-full bg-white object-cover dark:bg-neutral-600"
        />
      </div>
